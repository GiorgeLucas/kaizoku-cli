...
from kaizoku.core import Anime
from kaizoku.scraping import SearchManager
from kaizoku.ui.screens.episodes_screen import EpisodesScreen
from kaizoku.ui.widgets import AnimeSearchContainer, AnimesTableContainer
    ...
    def update_animes_datatable(self, animes_list: list[Anime]):
        ...
        for anime in animes_list:
            ...
            option_list.add_row(
                ...
                Text(
                    anime.provider.language.lang_name,
                    style=anime.provider.language.lang_color,
                ),
                key=anime.title,
            )
